        ...
        <div>
            ...
            <div className='flex-col pt-16 pl-32'>
                <div >
                    ...
                    <h1 className='text-3xl p-5 font-normal'>The White Sneakers Nearly Every Fashion Girls Own</h1>
                    <p className='font-light pl-6  text-[#97888f]'>by fashe-theme Admin |
                       <span className='text-[#666666] font-normal'>crafts, street style</span>  |
                        0 Comments</p>
